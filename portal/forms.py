...
class ApplicationForm(FlaskForm):
    ...
    professional_cert = FileField('Professional Certificates PDF!', validators=[ DataRequired(message="professional cert"), FileAllowed([ 'pdf','jpeg','jpg'], 'pdf/jpeg/jpg files only!')])
